...
class PachamamaRadioScraper:
    ...
    def find_all_archive_pages(self):
        """Encuentra todas las páginas de archivo y categorías"""
        archive_urls = set()
    ...
    def scrape_all_articles(self):
        """Función principal que extrae todas las noticias"""
        self.logger.info("Iniciando scraping de Pachamamaradio.org...")
        ...
        # 2. Buscar en páginas de archivo
        self.logger.info("Buscando en páginas de archivo...")
        archive_pages = self.find_all_archive_pages()
        ...
        self.logger.info(f"Total de enlaces de artículos encontrados: {len(all_article_links)}")
    ...
    def save_to_csv(self, filename="pachamamaradio_noticias.csv"):
    ...
    def save_to_json(self, filename="pachamamaradio_noticias.json"):
...
if __name__ == "__main__":
    ...
    print(f"- pachamamaradio_noticias.csv")
    print(f"- pachamamaradio_noticias.json")
    
    if articles:
        print(f"\\nEjemplo de artículo extraído:")
        print(f"Título: {articles[0]['titulo']}")
        print(f"Fecha: {articles[0]['fecha']}")
        print(f"Categoría: {articles[0]['categoria']}")
        print(f"Resumen: {articles[0]['resumen'][:100]}...")