#!/usr/bin/env python3
"""
Script directo para hacer scraping de Pachamama Radio AHORA
"""
...
def scrape_pachamamaradio():
    """Hacer scraping de Pachamama Radio"""
    print("🚀 Iniciando scraping de Pachamama Radio...")
    
    # Crear carpeta de datos
    os.makedirs("data/pachamamaradio", exist_ok=True)
    ...
    try:
        ...
        for link in soup.find_all('a', href=True):
            href = link['href']
            if href and base_url in href and '/seccion/' not in href and '/page/' not in href:
        ...
        json_file = f"data/pachamamaradio/pachamamaradio_{timestamp}.json"
...
if __name__ == "__main__":
    print("🕷️  Scraper de Pachamama Radio - Versión Simple")
    print("=" * 50)
    
    json_file, count = scrape_pachamamaradio()
    ...
    if json_file:
        ...
        print(f"2. Ejecuta: python migrate_pachamamaradio_to_db.py")
