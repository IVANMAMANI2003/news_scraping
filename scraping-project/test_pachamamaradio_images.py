#!/usr/bin/env python3
"""
Script de prueba para verificar la extracción de imágenes del spider de Pachamama Radio
...
def test_image_extraction():
    ...
    print("=" * 70)
    print("🧪 PRUEBA DE EXTRACCIÓN DE IMÁGENES - PACHAMAMA RADIO")
    print("=" * 70)
    ...
    article_urls = scraper.extract_article_links_from_home()
    ...
    csv_file = f"data/pachamamaradio/test_imagenes_{timestamp}.csv"
    ...
    for i, url in enumerate(test_urls, 1):
        ...
        try:
            ...
            if article_data:
                # Obtener imágenes (puede ser una lista o string)
                imagenes = article_data.get('imagenes', None)
                if imagenes is None:
                    images = []
                elif isinstance(imagenes, str):
                    images = [img.strip() for img in imagenes.split(',') if img.strip()]
                ...
                result_row = {
                    ...
                    'Todas_Imagenes': ', '.join(images) if images else '',
