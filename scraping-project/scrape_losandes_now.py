#!/usr/bin/env python3
"""
Script directo para hacer scraping de Los Andes AHORA
"""
...
def scrape_losandes():
    """Hacer scraping de Los Andes"""
    print("🚀 Iniciando scraping de Los Andes...")
    
    # Crear carpeta de datos
    os.makedirs("data/losandes", exist_ok=True)
    ...
    try:
        ...
        for link in soup.find_all('a', href=True):
            href = link['href']
            if href and base_url in href and '/wp-admin' not in href and '/page/' not in href:
        ...
        json_file = f"data/losandes/losandes_{timestamp}.json"
...
if __name__ == "__main__":
    print("🕷️  Scraper de Los Andes - Versión Simple")
    print("=" * 50)
    
    json_file, count = scrape_losandes()
    ...
    if json_file:
        ...
        print(f"2. Ejecuta: python migrate_losandes_to_db.py")
